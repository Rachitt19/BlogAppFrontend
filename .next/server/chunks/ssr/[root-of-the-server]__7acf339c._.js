...
const AuthProvider = ({ children })=>{
    ...
    const signUp = async (email, password, displayName)=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authAPI"].signup(email, password, displayName);
            if (result.success) {
    ...
    const signIn = async (email, password)=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authAPI"].signin(email, password);
            if (result.success) {
                localStorage.setItem('authToken', result.token);
                localStorage.setItem('user', JSON.stringify(result.user));
                setToken(result.token);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7acf339c._.js.map